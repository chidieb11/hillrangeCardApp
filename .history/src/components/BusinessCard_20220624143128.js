...
const BusinessCard = () => {
  return (
    <div>
      <div className="flex flex-col m-auto justify-center shadow-md rounded-md w-96 p-3 mt-20 cursor-pointer">
        <div className="flex justify-between">
          ...
          <div className="headerDetails mt-2 sm:ml-4 mb-10 text-center">
            <h1 className="capitalize whitespace-nowrap text-xl font-bold">
              george group of companies
            </h1>
            <p className="capitalize">(real estate, oil and gas, maritime)</p>
        ...
        <div className="footer flex justify-end">
          <h3>
            ...
            <span className="font-bold">George Amu</span> <br />
            08033221100
          </h3>
        </div>
      </div>
